...
echo "COSMOS_HOST=$(azd env get-value COSMOS_HOST)" >> $ENV_FILE_PATH
echo "COSMOS_DATABASE=$(azd env get-value COSMOS_DATABASE)" >> $ENV_FILE_PATH
echo "COSMOS_CONTAINER=$(azd env get-value COSMOS_CONTAINER)" >> $ENV_FILE_PATH
echo "AZURE_COSMOS_CONNECTION_STRING=$(azd env get-value AZURE_COSMOS_CONNECTION_STRING)" >> $ENV_FILE_PATH